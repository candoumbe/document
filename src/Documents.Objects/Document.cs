...
public class Document : AuditableEntity<DocumentId, Document>
{
    ...
    /// </summary>
    public NonNegativeLong Size { get; private set; }
    ...
    public void UpdateSize(NonNegativeLong newSize)
    {
    ...
    public void UpdateHash(string newHash)
    {
        ...
        Hash = newHash ?? throw new ArgumentNullException(nameof(newHash));
    }

    /// <summary>
    /// Changes <see cref="Document"/>' <see cref="Status"/> to <see cref="Status.Done"/>.
    /// <para>
    /// After calling this method, any call to <see cref="UpdateHash(string)"/>, <see cref="UpdateSize(NonNegativeLong)"/> will throw <see cref="InvalidOperationException"/>.
    /// </para>
    /// </summary>
