...
| --- | --- | --- | --- |
| Deckard | Lead | advisory | — |
| Rachael | Backend Dev | advisory | — |
| Gaff | Tester | advisory | — |
| Batty | DevOps | advisory | — |
| Rai | RAI Reviewer | review | — |
| Fact Checker | Fact Checker | advisory | — |

### Supported task types

Lead, Backend Dev, Tester, DevOps, RAI Reviewer, Fact Checker
...
- **Can:** review code and pull requests; responsible-AI and content-safety review
- **Cannot (no agent claims this):** write and modify code; write and run tests; write and maintain documentation; security and secrets review; cut releases and publish packages; author and maintain CI/CD workflows; UX and visual design; deploy to live environments
